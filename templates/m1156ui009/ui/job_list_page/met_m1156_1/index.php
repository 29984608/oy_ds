                ...
                <div class="met-job-list met-pager-ajax">
                    ...
                    <div class="widget widget-article widget-shadow">
                        <div class="widget-body">
                            ...
                            <a class="btn btn-success" role="button" href="javascript:;" data-toggle="modal" data-target="#met-job-cv" data-jobid="{$v.id}" data-cvurl="cv.php?lang=cn&selected" >{$ui.cvtitle}</a>
                            </div><hr style="border:1px dotted #CCCCCC;">
                            </if>
