...
METUI_FUN['search_met_m1156_5']=METUI['search_met_m1156_5_x']={
	name: 'search_met_m1156_5',
	init: function(){
		if($('.swiper-header').length==0){
			METUI['search_met_m1156_5_x'].slide(1);
		}
	},
	resize: function(res){
		
		if(!res) $(window).resize(function(){ METUI['search_met_m1156_5_x'].resize(true); });
	},
	slide: function(str){
		switch (str){
			case 1:
				if(!METUI['slide']){
					METUI['search_met_m1156_5']
						.css('background-image','url('+METUI['search_met_m1156_5'].attr('data-background')+')')
...
var x=new metui(METUI_FUN['search_met_m1156_5']);
