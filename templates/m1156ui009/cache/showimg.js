	...
	slide: function(str){
		switch (str){
			case 1:
				...
				METUI['img_list_detail_met_m1156_1'].find(".met-editor,.shownews-container").wrapInner("<div class='editorlightgallery'></div>");
				METUI['img_list_detail_met_m1156_1'].find(".met-editor,.shownews-container").each(function() {
					var img_gallery_open=1,
						this_editor=this;
					METUI['img_list_detail_met_m1156_1'].find("img",this).one('click',function() {
						if(img_gallery_open){
							METUI['img_list_detail_met_m1156_1'].find('img',this_editor).each(function() {
							...
							METUI['img_list_detail_met_m1156_1'].find('.editorlightgallery',this_editor).galleryLoad();
