...
METUI_FUN['product_list_page_met_m1156_4']=METUI['product_list_page_met_m1156_4_x']={
	name: 'product_list_page_met_m1156_4',
	init: function(){
		if($('.swiper-header').length==0){
			METUI['product_list_page_met_m1156_4_x'].slide(1);
		}
	},
	resize: function(res){
		
		if(!res) $(window).resize(function(){ METUI['product_list_page_met_m1156_4_x'].resize(true); });
	},
	slide: function(str){
		switch (str){
			case 1:
				if(!METUI['slide']){
					METUI['product_list_page_met_m1156_4']
						.css('background-image','url('+METUI['product_list_page_met_m1156_4'].attr('data-background')+')')
						.removeAttr('data-background')
				}
				
				METUI['product_list_page_met_m1156_4'].find('.host-list dd').mouseover(function(){
					that=$(this);
...
var x=new metui(METUI_FUN['product_list_page_met_m1156_4']);
