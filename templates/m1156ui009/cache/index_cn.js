...
METUI_FUN['column_list_met_m1156_6']=METUI['column_list_met_m1156_6_x']={
	name: 'column_list_met_m1156_6',
	IE9: navigator.userAgent.indexOf('MSIE 9.0')>0,
	init: function(){
		if($('.swiper-header').length==0){
			METUI['column_list_met_m1156_6_x'].slide(1);
		}		
	},
	resize: function(res){
		
		if(!res) $(window).resize(function(){ METUI['column_list_met_m1156_6_x'].resize(true); });
	},
	grid: function(){
	...
	slide: function(str){
		switch (str){
			case 1:
				if(!METUI['slide']){
					METUI['column_list_met_m1156_6']
						.css('background-image','url('+METUI['column_list_met_m1156_6'].attr('data-background')+')')
						.removeAttr('data-background');
				}
				if(METUI['column_list_met_m1156_6'].find('img[data-original]').length>0){
					METUI['column_list_met_m1156_6'].find('img[data-original]').loadlazy({
						load: function(){
							METUI['column_list_met_m1156_6_x'].grid();
							$(this).removeClass('data-original');
						}
					});
				}
				METUI['column_list_met_m1156_6'].addClass('active');
			break;
			case 2:
				METUI['column_list_met_m1156_6'].addClass('active');
			break;
			case 3:
				METUI['column_list_met_m1156_6'].removeClass('active');
			break;
		}
	}
}
var x=new metui(METUI_FUN['column_list_met_m1156_6']);



METUI_FUN['about_list_met_m1156_6']=METUI['about_list_met_m1156_6_x']={
	name: 'about_list_met_m1156_6',
	init: function(){
		if($('.swiper-header').length==0){
			METUI['about_list_met_m1156_6_x'].slide(1);
		}		
	},
	resize: function(res){
		
		if(!res) $(window).resize(function(){ METUI['about_list_met_m1156_6_x'].resize(true); });
	},
	slide: function(str){
		switch (str){
			case 1:
				if(!METUI['slide']){
					METUI['about_list_met_m1156_6']
						.css('background-image','url('+METUI['about_list_met_m1156_6'].attr('data-background')+')')
						.removeAttr('data-background');
				}
				
				METUI['about_list_met_m1156_6'].addClass('active');
			break;
			case 2:
				if(METUI['about_list_met_m1156_6_anenst']) METUI['about_list_met_m1156_6_anenst'].init();
				METUI['about_list_met_m1156_6'].addClass('active');
			break;
			case 3:
				if(METUI['about_list_met_m1156_6_anenst']) METUI['about_list_met_m1156_6_anenst'].destroy(false);
				METUI['about_list_met_m1156_6'].removeClass('active');
			break;
		}
	}
}
var x=new metui(METUI_FUN['about_list_met_m1156_6']);



METUI_FUN['show_list_met_m1156_6']=METUI['show_list_met_m1156_6_x']={
	name: 'show_list_met_m1156_6',
	init: function(){
		if($('.swiper-header').length==0){
			METUI['show_list_met_m1156_6_x'].slide(1);
		}		
	},
	resize: function(res){
		
		if(!res) $(window).resize(function(){ METUI['show_list_met_m1156_6_x'].resize(true); });
	},
	slide: function(str){
		switch (str){
			case 1:
				if(!METUI['slide']){
					METUI['show_list_met_m1156_6']
						.css('background-image','url('+METUI['show_list_met_m1156_6'].attr('data-background')+')')
						.removeAttr('data-background');
				}
				
				
				
				if(METUI['show_list_met_m1156_6'].find('.multi-slide').length>1){
					METUI['show_list_met_m1156_6_multi']=new Swiper('.show_list_met_m1156_6 .multi-move',{
					...
					n=1;
					METUI['show_list_met_m1156_6'].find('.multi-left').click(function(){
						n--;
						if(n<1) n=METUI['show_list_met_m1156_6'].find('.multi-slide').length-2;
						METUI['show_list_met_m1156_6_multi'].slideTo(n);
					});
					METUI['show_list_met_m1156_6'].find('.multi-right').click(function(){
						n++;
						if(n>METUI['show_list_met_m1156_6'].find('.multi-slide').length-1) n=2;
						METUI['show_list_met_m1156_6_multi'].slideTo(n);
					});
					...
					METUI['show_list_met_m1156_6']
						...
						.addClass('swiper-slide-active')
						.find('.multi-lazy')
						.css('background-image','url('+METUI['show_list_met_m1156_6'].find('.multi-lazy').attr('data-background')+')');
					METUI['show_list_met_m1156_6'].find('.multi-left,.multi-right').remove();
				}
				
				METUI['show_list_met_m1156_6'].addClass('active');
			break;
			case 2:
				if(METUI['show_list_met_m1156_6_anenst']) METUI['show_list_met_m1156_6_anenst'].init();
				METUI['show_list_met_m1156_6'].addClass('active');
			break;
			case 3:
				if(METUI['show_list_met_m1156_6_anenst']) METUI['show_list_met_m1156_6_anenst'].destroy(false);
				METUI['show_list_met_m1156_6'].removeClass('active');
			break;
		}
	}
}
var x=new metui(METUI_FUN['show_list_met_m1156_6']);



METUI_FUN['img_list_met_m1156_6']=METUI['img_list_met_m1156_6_x']={
	name: 'img_list_met_m1156_6',
	init: function(){
		if($('.swiper-header').length==0){
			METUI['img_list_met_m1156_6_x'].slide(1);
		}		
	},
	resize: function(res){
		
		if(!res) $(window).resize(function(){ METUI['img_list_met_m1156_6_x'].resize(true); });
	},
	slide: function(str){
		switch (str){
			case 1:
				if(!METUI['slide']){
					METUI['img_list_met_m1156_6']
						.css('background-image','url('+METUI['img_list_met_m1156_6'].attr('data-background')+')')
						.removeAttr('data-background');
				}
				
				
				
				if(METUI['img_list_met_m1156_6'].find('.case-slide').length>0){
					METUI['img_list_met_m1156_6_case']=new Swiper('.img_list_met_m1156_6 .case-container',{
						...
						watchSlidesProgress : true,
						watchSlidesVisibility : true, 
						prevButton: '.img_list_met_m1156_6 .case-left',
						nextButton: '.img_list_met_m1156_6 .case-right'
					});  
				} 
				
					
				METUI['img_list_met_m1156_6'].find('.case-slide a').click(function(){
				...
				METUI['img_list_met_m1156_6'].addClass('active');
			break;
			case 2:
				if(METUI['img_list_met_m1156_6_anenst']) METUI['img_list_met_m1156_6_anenst'].init();
				METUI['img_list_met_m1156_6'].addClass('active');
			break;
			case 3:
				if(METUI['img_list_met_m1156_6_anenst']) METUI['img_list_met_m1156_6_anenst'].destroy(false);
				METUI['img_list_met_m1156_6'].removeClass('active');
			break;
		}
	}
}
var x=new metui(METUI_FUN['img_list_met_m1156_6']);



METUI_FUN['video_list_met_m1156_6']=METUI['video_list_met_m1156_6_x']={
	name: 'video_list_met_m1156_6',
	init: function(){
		if($('.swiper-header').length==0){
			METUI['video_list_met_m1156_6_x'].slide(1);
		}		
	},
	resize: function(res){
		
		if(!res) $(window).resize(function(){ METUI['video_list_met_m1156_6_x'].resize(true); });
	},
	slide: function(str){
		switch (str){
			case 1:
				if(!METUI['slide']){
					METUI['video_list_met_m1156_6']
						.css('background-image','url('+METUI['video_list_met_m1156_6'].attr('data-background')+')')
						.removeAttr('data-background');
				}
				
				
				if( METUI['video_list_met_m1156_6'].find('video').attr('data-play')==0 ){
					$('.video-content span').fadeOut();
					METUI['video_list_met_m1156_6'].find('video').trigger('play').attr('data-play',1).attr('controls','controls');
				}
				
				
				$('.video-content span').click(function(){
					$(this).fadeOut();
					METUI['video_list_met_m1156_6'].find('video').trigger('play').attr('controls','controls'); 
				}); 
				
		
				METUI['video_list_met_m1156_6'].addClass('active');
			break;
			case 2:
				if(METUI['video_list_met_m1156_6_anenst']) METUI['video_list_met_m1156_6_anenst'].init();
				METUI['video_list_met_m1156_6'].addClass('active');
			break;
			case 3:
				if(METUI['video_list_met_m1156_6_anenst']) METUI['video_list_met_m1156_6_anenst'].destroy(false);
				METUI['video_list_met_m1156_6'].removeClass('active');
			break;
		}
	}
}
var x=new metui(METUI_FUN['video_list_met_m1156_6']);



METUI_FUN['news_list_met_m1156_6']=METUI['news_list_met_m1156_6_x']={
	name: 'news_list_met_m1156_6',
	init: function(){
		if($('.swiper-header').length==0){
			METUI['news_list_met_m1156_6_x'].slide(1);
		}		
	},
	resize: function(res){
		
		if(!res) $(window).resize(function(){ METUI['news_list_met_m1156_6_x'].resize(true); });
	},
	slide: function(str){
		switch (str){
			case 1:
				if(!METUI['slide']){
					METUI['news_list_met_m1156_6']
						.css('background-image','url('+METUI['news_list_met_m1156_6'].attr('data-background')+')')
						.removeAttr('data-background');
				}
				
				
				METUI['news_list_met_m1156_6'].addClass('active');
			break;
			case 2:
			...
			case 3:
				...
				METUI['news_list_met_m1156_6'].removeClass('active');
			break;
		}
	}
}
var x=new metui(METUI_FUN['news_list_met_m1156_6']);
