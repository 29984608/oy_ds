...
METUI_FUN['img_list_page_met_m1156_3']=METUI['img_list_page_met_m1156_3_x']={
	name: 'img_list_page_met_m1156_3',
	init: function(){
		if($('.swiper-header').length==0){
			METUI['img_list_page_met_m1156_3_x'].slide(1);
		}
	},
	resize: function(res){
		
		if(!res) $(window).resize(function(){ METUI['img_list_page_met_m1156_3_x'].resize(true); });
	},
	slide: function(str){
		switch (str){
			case 1:
				if(!METUI['slide']){
					METUI['img_list_page_met_m1156_3']
						.css('background-image','url('+METUI['img_list_page_met_m1156_3'].attr('data-background')+')')
						.removeAttr('data-background')
				}
				METUI['img_list_page_met_m1156_3'].find('.img-li p').click(function(){
...
var x=new metui(METUI_FUN['img_list_page_met_m1156_3']);
