...
METUI_FUN['show_met_m1156_4']=METUI['show_met_m1156_4_x']={
	name: 'show_met_m1156_4',
	init: function(){
		if($('.swiper-header').length==0){
			METUI['show_met_m1156_4_x'].slide(1);
		}	
	},
	resize: function(res){
		
		if(!res) $(window).resize(function(){ METUI['show_met_m1156_4_x'].resize(true); });
	},
	slide: function(str){
		switch (str){
			case 1:
				if(!METUI['slide']){
					METUI['show_met_m1156_4']
						.css('background-image','url('+METUI['show_met_m1156_4'].attr('data-background')+')')
						.removeAttr('data-background')
				}
				if(METUI['show_met_m1156_4'].find(".met-editor img").length){
					if (!METUI['show_met_m1156_4'].find(".met-editor.no-gallery").length) {
						METUI['show_met_m1156_4'].find(".met-editor").wrapInner("<div class='editorlightgallery'></div>");
						METUI['show_met_m1156_4'].find(".met-editor").each(function() {
							var img_gallery_open=1,
								this_editor=this;
							METUI['show_met_m1156_4'].find("img",this).one('click',function() {
								if(img_gallery_open){
									METUI['show_met_m1156_4'].find('img',this_editor).each(function() {
									...
									METUI['show_met_m1156_4'].find('.editorlightgallery',this_editor).galleryLoad();
...
var x=new metui(METUI_FUN['show_met_m1156_4']);
