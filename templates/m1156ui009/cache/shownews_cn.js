...
METUI_FUN['news_list_detail_met_m1156_4']=METUI['news_list_detail_met_m1156_4_x']={
	name: 'news_list_detail_met_m1156_4',
	init: function(){
		if($('.swiper-header').length==0){
			METUI['news_list_detail_met_m1156_4_x'].slide(1);
		}
	},
	resize: function(res){
		
		if(!res) $(window).resize(function(){ METUI['news_list_detail_met_m1156_4_x'].resize(true); });
	},
	slide: function(str){
		switch (str){
			case 1:
				if(!METUI['slide']){
					METUI['news_list_detail_met_m1156_4']
						.css('background-image','url('+METUI['news_list_detail_met_m1156_4'].attr('data-background')+')')
...
var x=new metui(METUI_FUN['news_list_detail_met_m1156_4']);
